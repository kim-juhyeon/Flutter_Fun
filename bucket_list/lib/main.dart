...
//Create / Read / Update / Delete의 앞 글자를 따서 CRUD라고 부릅니다.
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  title: Text(
                    ...
                    style: TextStyle(
                      ...
                      decoration: bucket.isDone
                          ? TextDecoration.lineThrough //텍스트 중앙에 선이 그어짐
                          : TextDecoration.none,
                    ),
                  ),
                  // 삭제 아이콘 버튼
                  ...
                  onTap: () {
                    // 아이템 클릭시
                    setState(() {
                      bucket.isDone = !bucket.isDone; //isDone 상태변경
                    });
                  },
                );
              },
...
/// 버킷 생성 페이지
/// 화면 갱신을 하여 에러 메시지를 띄워야 하므로 stateful로 변경
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  if (job.isEmpty) {
                    ...
                    Navigator.pop(context, job); //job 변수를 반환
                  }
